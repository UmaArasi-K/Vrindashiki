...
import type { CommunityMember, NeighborhoodChallenge, ApiResponse } from '../types';
...
const CHALLENGES: NeighborhoodChallenge[] = [
  {
    id: 'ch-1',
...
--------------------------------------------------------------- */
router.get('/leaderboard', authMiddleware, (req: AuthRequest, res: Response<ApiResponse<CommunityMember[]>>) => {
...
--------------------------------------------------------------- */
router.get('/challenges', authMiddleware, (_req: AuthRequest, res: Response<ApiResponse<NeighborhoodChallenge[]>>) => {
...
--------------------------------------------------------------- */
router.post('/challenges/:id/join', authMiddleware, (req: AuthRequest, res: Response<ApiResponse<null>>) => {
  const { id } = req.params;
